...
- Processing of Geopotential Height (z500) data: detrending, climatology, anomalies, k-means clustering (hemispheric detrending is a separate file, and used only for comparison)
